...
const CollectionStat = (props: CollectionStatProp) => {
  ...
  return (
    <div className="min-w-[250px] w-10/12 justify-self-end	h-10 bg-gradient-to-r from-transparent via-blue-800 to-transparent	 rounded-md p-2 flex items-center justify-between">
